...
public class Module implements Comparable<Module>{
	...
	private ArrayList<String> clashedModules; // other Modules that must be ran
												// at same time
	private HashMap<String, Integer> coupledModules; // modules that cannot be
														// ran on same day (ie
														// other modules also
														// taken by students on
														// this module)
	...
	public Module(ArrayList<Module> modules) {
		...
		for (Module module : modules) {
			...
			if (module.getExamLength() > this.examLength) { // note, might need
															// different room
															// types as well.
