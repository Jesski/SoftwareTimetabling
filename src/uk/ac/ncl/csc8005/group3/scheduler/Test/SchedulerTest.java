...
public class SchedulerTest {
	...
	public void manageDupicateModulesTest(){
		...
		System.out.println(scheduler.manageDupicateModules(modules));
	}
	...
	public void addData() {
		...
		modules.add(new Module("CSC8001", clashedModules1, coupledModules1,	120, 15, "CMP"));
		...
		rooms.add(new Room("4", "LCT", 540, 720, 0, 1000));
		rooms.add(new Room("5", "LCT", 780, 1020, 0, 1000));
	}
